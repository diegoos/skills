...
- **Body:** headings the repo earns (stack, assumptions, commands, style with a snippet, constraints, boundaries, git). No required section names. When a heading is earned, prefer a familiar name (`Commands`, `Testing`, `Boundaries`, `Conventions`, `Structure`).
