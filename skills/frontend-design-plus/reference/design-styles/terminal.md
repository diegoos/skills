...
4. Subtract this Path cliché in Commit. QA owns anti-slop and crit. Done when the common-layout check fails for this style's own cliché: charcoal developer portfolio with one orange accent and a fake terminal window in the hero.
