...
4. Subtract this Path cliché in Commit. QA owns anti-slop and crit. Done when the common-layout check fails for this style's own cliché: parody GeoCities page where controls are pictures and labels are missing.
