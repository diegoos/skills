...
4. Run anti-slop + crit. Done when the common-layout check fails for this style's own cliché: doodle-only UI where form labels are scribbles with no readable names.
