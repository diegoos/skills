...
4. Run anti-slop + crit. Done when the common-layout check fails for this style's own cliché: generic modern-dark landing with a yellow button and a still, centered hero.
