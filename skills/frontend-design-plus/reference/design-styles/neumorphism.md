...
4. Subtract this Path cliché in Commit. QA owns anti-slop and crit. Done when the common-layout check fails for this style's own cliché: low-contrast grey pills whose edges exist only as blur.
