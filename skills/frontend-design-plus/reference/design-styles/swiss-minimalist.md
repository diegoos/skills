...
4. Subtract this Path cliché in Commit. QA owns anti-slop and crit. Done when the common-layout check fails for this style's own cliché: Inter-on-white with a red button and fake `01 / 02 / 03` section markers.
