...
4. Subtract this Path cliché in Commit. QA owns anti-slop and crit. Done when the common-layout check fails for this style's own cliché: indigo-violet corporate landing with three equal feature cards and a generic navy-Inter read.
