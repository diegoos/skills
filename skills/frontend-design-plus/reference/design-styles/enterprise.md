...
1. Keep the layout family the user named. If none, name one from layout-patterns.md or product-register.md (top bar + side nav, split / master-detail, or spec / comparison). Done when that name is in the Lock.
