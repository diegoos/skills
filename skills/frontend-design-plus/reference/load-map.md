...
| **App UI**    | [design-md.md](design-md.md), [product-register.md](product-register.md), [ux-principles.md](ux-principles.md), [production-engineering.md](production-engineering.md), [surfaces.md](surfaces.md), [motion.md](motion.md) Product micro. [file-architecture.md](file-architecture.md) when origin is greenfield. | [layout-patterns.md](layout-patterns.md), [assets.md](assets.md), [design-styles.md](design-styles.md), `design-styles/*.md` unless Look is a named catalog `id`                                |
...
| App UI (any Behave)                                                                | [motion.md](motion.md) Product micro                                                                                       | Brand choreography unless Behave / Lock is `fluid` / `cinematic` |
| Constraints or Look name photo, video, or illustration                             | [assets.md](assets.md)                                                                                                     | —                                                                |
| No media named                                                                     | —                                                                                                                          | [assets.md](assets.md)                                           |
| Greenfield **marketing** Look is a catalog `id`                                    | that one `design-styles/<id>.md` at Direction                                                                              | the rest of `design-styles/`                                     |
| Greenfield **marketing** Look is `you-decide` / `none`, or invent-all on marketing | [design-styles.md](design-styles.md) Pick, then one `design-styles/<id>.md` at Direction                                   | the rest of `design-styles/`                                     |
| App UI Look is a named catalog `id`                                                | that one `design-styles/<id>.md` at Direction (craft blanks only; layout stays [product-register.md](product-register.md)) | the rest of `design-styles/`                                     |
