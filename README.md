...
| `[frontend-design-plus](skills/frontend-design-plus/)` | Build or restyle landings, dashboards, and components. Origin from disk (`greenfield`, `redesign`, `polish`). Scores the briefing once, asks remaining fields in one structured call when the harness allows, then ships UI with DESIGN.md, a Lock, written crit, and pre-flight.                                                                                                    |
