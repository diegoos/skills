...
| `[frontend-design-plus](skills/frontend-design-plus/)` | Build or restyle landings, dashboards, and components. Origin from disk (`greenfield`, `redesign`, `polish`). Asks unanswered fields, then ships UI with DESIGN.md, a Lock, written crit, and pre-flight.                                                                                                                                                                            |
